object frmApprovalSpkPot: TfrmApprovalSpkPot
  Left = 241
  Top = 114
  ...
  object zqrKorHead: TZReadOnlyQuery
    ...
    SQL.Strings = (
      'SELECT a.no_bukti, a.tanggal, a.user, a.user_dept, b.email'
        ...
        'FROM tbl_trsspkpotong_head a LEFT JOIN tbl_user b ON a.user = b.' +
        'nama'
  ...
  object zqrDetKor: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'SELECT a.*,IF(a.jenis='#39'OUT'#39','#39'DIPOTONG'#39','#39'HASIL POTONG'#39') AS jenis2' +
        ', '
      'b.deskripsi FROM tbl_trsspkpotong_det a '
