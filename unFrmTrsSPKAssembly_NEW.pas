...
type
  TFrmTrsSPKAssembly_NEW = class(TfrmTplTrans)
    cxLabel1: TcxLabel;
...
var
  frmTrsSPKAssembly_NEW: TFrmTrsSPKAssembly_NEW;
...
procedure TFrmTrsSPKAssembly_NEW.FormCreate(Sender: TObject);
var
  q: TZQuery;
begin
  inherited;
...
function TFrmTrsSPKAssembly_NEW.CekKodeBrg(sKodeBrg : String; Row: Integer) : Boolean;
var
  i: integer;
  tmp: Boolean;
begin
...
procedure TFrmTrsSPKAssembly_NEW.NxEdit1DblClick(Sender: TObject);
var
  f: TFrmCari;
  s: TStringList;
  fKode: TField;
...
procedure TFrmTrsSPKAssembly_NEW.nxGrdAfterEdit(Sender: TObject; ACol, ARow: Integer;
  Value: WideString);
var
  q: TZQuery;
  i: integer;
...
procedure TFrmTrsSPKAssembly_NEW.HitungTotal;
var
  i: integer;
  tmp, tmpQty: Real;
begin
...
procedure TFrmTrsSPKAssembly_NEW.ClearAll;
var
  i: Integer;
begin
...
procedure TFrmTrsSPKAssembly_NEW.btnBatalClick(Sender: TObject);
begin
  inherited;
  ClearAll;
  Self.Jenis := '';
...
procedure TFrmTrsSPKAssembly_NEW.btnSimpanClick(Sender: TObject);
var
  in_head, in_det, barang, barang_det, hist: TZTable;
  sNoTrs, sNoSPK, sNoMO: string;
  i: integer;
  b: Boolean;
  qspk,qmo,q, qbom, qbomd: TZQuery;
begin
    ...
    try
      ...
      if Self.Jenis = 'tambah' then begin
        with qspk do begin
          ...
          //FieldByName('keterangan').AsString := nxGrd.Cell[nxColKeterangan.Index, 0].AsString;
          FieldByName('keterangan').AsString := cxtKetPPIC.Text;
          FieldByName('jenis_spk').AsString := 'SPK ASSEMBLY';
...
procedure TFrmTrsSPKAssembly_NEW.nxGrdCellDblClick(Sender: TObject; ACol, ARow: Integer);
begin
...
procedure TFrmTrsSPKAssembly_NEW.btnHapusClick(Sender: TObject);
var
  q: TZQuery;
  i: Integer;
begin
...
procedure TFrmTrsSPKAssembly_NEW.cxCmbGdgPropertiesChange(Sender: TObject);
begin
  inherited;
  try
...
procedure TFrmTrsSPKAssembly_NEW.btnTambahClick(Sender: TObject);
var
  s: TStringList;
  fKode: TField;
  ACol, ARow: Integer;
...
procedure TFrmTrsSPKAssembly_NEW.cxCmbGdgEnter(Sender: TObject);
begin
  inherited;
  if cxsTotalQty.Value > 0 then
...
procedure TFrmTrsSPKAssembly_NEW.cxdTglTrsPropertiesChange(Sender: TObject);
begin
...
procedure TFrmTrsSPKAssembly_NEW.btnEdit2Click(Sender: TObject);
var
  q, qBrg: TZQuery;
  i,j,k: Integer;
begin
...
procedure TFrmTrsSPKAssembly_NEW.cxCmbGdg2PropertiesChange(Sender: TObject);
begin
  try
...
procedure TFrmTrsSPKAssembly_NEW.btnTambah2Click(Sender: TObject);
var
  s: TStringList;
  fKode: TField;
  ACol, ARow: Integer;
...
procedure TFrmTrsSPKAssembly_NEW.FormShow(Sender: TObject);
  var
  q, qSO, qbd, qspk, qmo: TZQuery;
  i: Integer;
begin
  cxCmbGdg.Text := 'G01';
  cxCmbGdg.Properties.ReadOnly := True;
...
function TFrmTrsSPKAssembly_NEW.GetRow(grd: TNextGrid): Integer;
var
  i,j: Integer;
begin
  j := 0;
...
procedure TFrmTrsSPKAssembly_NEW.nxGrd2CellDblClick(Sender: TObject; ACol,
  ARow: Integer);
begin
...
procedure TFrmTrsSPKAssembly_NEW.nxGrd2AfterEdit(Sender: TObject; ACol,
...
procedure TFrmTrsSPKAssembly_NEW.cxLUBrgKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key = #13 then
    btnTambahClick(nil);
...
procedure TFrmTrsSPKAssembly_NEW.cxLUBrg2KeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key = #13 then
    btnTambah2Click(nil);
...
procedure TFrmTrsSPKAssembly_NEW.btnCariBrgClick(Sender: TObject);
var
  f: TFrmCari;
  s: TStringList;
  fKode: TField;
...
procedure TFrmTrsSPKAssembly_NEW.btnCariBrg2Click(Sender: TObject);
var
  f: TFrmCari;
  s: TStringList;
  fKode: TField;
...
procedure TFrmTrsSPKAssembly_NEW.nxColBtnEditButtonClick(Sender: TObject);
var
  i: integer;
begin
  i := nxGrd.SelectedRow;
...
procedure TFrmTrsSPKAssembly_NEW.pnlMemoExit(Sender: TObject);
begin
  pnlMemo.Visible := False;
end;

procedure TFrmTrsSPKAssembly_NEW.btnSimpanKetClick(Sender: TObject);
begin
...
procedure TFrmTrsSPKAssembly_NEW.btnBatalMemoClick(Sender: TObject);
begin
  inherited;
  pnlMemo.Visible := False;
end;

procedure TFrmTrsSPKAssembly_NEW.FormCloseQuery(Sender: TObject;
...
procedure TFrmTrsSPKAssembly_NEW.Button1Click(Sender: TObject);
begin
  inherited;
  MsgBox(Self.Jenis);
end;
