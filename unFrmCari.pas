...
begin
  ...
  if mJenis = 'mutasi' then begin
    ...
    else if mJenis = 'gudang' then begin
    sql := 'SELECT kode, nama FROM tbl_gudang where f_aktif=1  ORDER BY nama';
    ColCaption.CommaText := 'Kode,Nama';
    ColWidth.CommaText := '100,300';
    Width := Width + 400;
    caption := 'Cari Gudang';
  end
