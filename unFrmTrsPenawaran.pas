...
type
  TfrmTrsPenawaran = class(TfrmTplTrans)
    cxLabel6: TcxLabel;
...
var
  frmTrsPenawaran: TFrmTrsPenawaran;
...
procedure TFrmTrsPenawaran.FormCreate(Sender: TObject);
var
  q: TZQuery;
begin
...
procedure TFrmTrsPenawaran.btnBaruClick(Sender: TObject);
begin
  inherited;
...
function TFrmTrsPenawaran.CekKodeBrg(sKodeBrg : String; Row: Integer) : Boolean;
var
  i: integer;
  tmp: Boolean;
begin
...
procedure TFrmTrsPenawaran.NxEdit1DblClick(Sender: TObject);
var
  f: TFrmCari;
  s: TStringList;
  fKode: TField;
...
procedure TFrmTrsPenawaran.nxGrdAfterEdit(Sender: TObject; ACol, ARow: Integer;
  Value: WideString);
var
  q: TZQuery;
  i: integer;
...
procedure TFrmTrsPenawaran.HitungTotal;
var
  i: integer;
  tmp, tmpQty: Real;
begin
...
procedure TFrmTrsPenawaran.ClearAll;
var
  i: Integer;
begin
...
procedure TFrmTrsPenawaran.btnBatalClick(Sender: TObject);
begin
  inherited;
  ClearAll;
  Self.Jenis := '';
...
procedure TFrmTrsPenawaran.btnSimpanClick(Sender: TObject);
var
...
procedure TFrmTrsPenawaran.btnHapusClick(Sender: TObject);
var
  q: TZQuery;
  i: Integer;
begin
...
procedure TFrmTrsPenawaran.cxCmbGdgPropertiesChange(Sender: TObject);
var
  s: string;
begin
  s := cxCmbDept.Text;
...
procedure TFrmTrsPenawaran.btnTambahClick(Sender: TObject);
var
  s: TStringList;
  fKode: TField;
  ACol, ARow: Integer;
...
procedure TFrmTrsPenawaran.cxdTglTrsPropertiesChange(Sender: TObject);
begin
...
procedure TFrmTrsPenawaran.btnEdit2Click(Sender: TObject);
var
  q, qBrg: TZQuery;
  sNoFOBJ, sSQL: string;
  i: Integer;
...
procedure TFrmTrsPenawaran.AddRow(sNoSO, sKodeBrg: string; qty_so, qty_g02: real);
var
  f: TFrmCari;
  fs: TfrmCariSO;
  s: TStringList;
...
procedure TFrmTrsPenawaran.cxLUBrgKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    btnTambahClick(nil);
end;

procedure TFrmTrsPenawaran.nxBeNoSOButtonClick(Sender: TObject);
var
  f: TfrmCari;
  ARow, ACol: Integer;
  s: TStringList;
...
procedure TFrmTrsPenawaran.nxBtnEditSOButtonClick(Sender: TObject);
var
  f: TfrmCari;
  ARow, ACol: Integer;
  s: TStringList;
...
procedure TFrmTrsPenawaran.btnCariBrgClick(Sender: TObject);
var
  f: TFrmCari;
  s: TStringList;
  fKode: TField;
...
procedure TfrmTrsPenawaran.cxlNoFOBJPropertiesEditValueChanged(
  Sender: TObject);
var
  q, qd, qh: TZQuery;
  i: Integer;
...
procedure TfrmTrsPenawaran.cxChkPil1Click(Sender: TObject);
var
  chk: TcxCheckBox;
begin
