...
type
  TfrmPenerimaanKas2 = class(TfrmTplTrans2)
    nxGrd: TNextGrid;
    cxLabel1: TcxLabel;
...
var
  frmPenerimaanKas2: TFrmPenerimaanKas2;
...
procedure TFrmPenerimaanKas2.nxColAkunButtonClick(Sender: TObject);
var
  f: TFrmCari;
  s: TStringList;
...
procedure TFrmPenerimaanKas2.FormCreate(Sender: TObject);
var
  q: TZQuery;
begin
  inherited;
...
procedure TFrmPenerimaanKas2.nxGrdAfterEdit(Sender: TObject; ACol,
...
procedure TFrmPenerimaanKas2.nxColNoTransButtonClick(Sender: TObject);
var
  f: TFrmCari;
  s: TStringList;
  fNoTrs: TField;
...
procedure TFrmPenerimaanKas2.btnSimpanClick(Sender: TObject);
var
  i, id: Integer;
  f: boolean;
  qjh, qjd: TZQuery;
...
procedure TFrmPenerimaanKas2.ClearAll;
begin
  nxGrd.ClearRows;
  cxdTgl.Text := '';
  cxlAkun.Text := '';
...
procedure TFrmPenerimaanKas2.btnBaruClick(Sender: TObject);
begin
  inherited;
//  cxtNoTrans.Text := GetLastFak('jurnal');
  {
...
procedure TFrmPenerimaanKas2.HitungTotal;
var
  i,total: Integer;
begin
  total := 0;
...
procedure TFrmPenerimaanKas2.nxGrdCellDblClick(Sender: TObject; ACol,
  ARow: Integer);
begin
  inherited;
...
procedure TFrmPenerimaanKas2.cxlAkunPropertiesChange(Sender: TObject);
begin
  inherited;
...
procedure TFrmPenerimaanKas2.btnProsesEditClick(Sender: TObject);
var
  q: TZQuery;
  i: Integer;
begin
 ...
 { if cxlCari.Text = '' then Abort;
  ...
  zqrEdit.Locate('no_jurnal', cxlCari.EditValue,[]);
  ...
  q := OpenRS('SELECT * FROM v_jurnal ' +
    'WHERE no_jurnal = ''%s'' ' +
    'AND kredit > 0 ORDER BY urutan',[zqrEdit.FieldByName('no_jurnal').AsString]);
...
procedure TFrmPenerimaanKas2.cxTblFocusedItemChanged(
...
procedure TFrmPenerimaanKas2.btnBatalClick(Sender: TObject);
begin
  inherited;
  ClearAll;
end;

procedure TFrmPenerimaanKas2.btnCariEditClick(Sender: TObject);
var
  f: TFrmCari;
  s: TStringList;
  fld: TField;
begin
  ...
  //  f.Jenis := 'penerimaan-kas-non-tunai'
  //else
    f.Jenis := 'penerimaan-kas';
  f.ShowModal;
...
procedure TfrmPenerimaanKas2.FormShow(Sender: TObject);
var
  q : TZQuery ;
begin
...
procedure TfrmPenerimaanKas2.btnHapusClick(Sender: TObject);
var
  i: Integer;
begin
  inherited;
...
procedure TfrmPenerimaanKas2.btnEditClick(Sender: TObject);
begin
  inherited;
 { if mJenisAkun <> 'non-tunai' then begin
    try
...
procedure TfrmPenerimaanKas2.cxdTglExit(Sender: TObject);
begin
  inherited;
  inherited;
  if mJenisAkun = 'non-tunai' then begin
...
procedure TfrmPenerimaanKas2.cxdTglPropertiesChange(Sender: TObject);
begin
  inherited;
