...
type
  TfrmSalesOrderB = class(TfrmTplTrans)
    cxLabel1: TcxLabel;
...
procedure TFrmSalesOrderB.CreateParams(var Params: TCreateParams);
begin
  inherited CreateParams(Params);
  Params.ExStyle := Params.ExStyle or WS_EX_APPWINDOW;
end;

procedure TFrmSalesOrderB.FormCreate(Sender: TObject);
var
  q: TZQuery;
  lst: TStringList;
  i: Integer;
...
procedure TFrmSalesOrderB.btnBaruClick(Sender: TObject);
begin
  inherited;
...
function TFrmSalesOrderB.CekKodeBrg(sKodeBrg : String; Row: Integer) : Boolean;
var
  i: integer;
  tmp: Boolean;
begin
...
procedure TFrmSalesOrderB.NxEdit1DblClick(Sender: TObject);
var
  f: TFrmCari;
  s: TStringList;
  fKode: TField;
...
procedure TFrmSalesOrderB.nxGrdAfterEdit(Sender: TObject; ACol, ARow: Integer;
  Value: WideString);
var
  q: TZQuery;
  i: integer;
...
procedure TFrmSalesOrderB.HitungTotal;
var
  i: integer;
  tmp, tmpQty: Real;
begin
...
procedure TFrmSalesOrderB.ClearAll;
var
  i: Integer;
begin
...
procedure TFrmSalesOrderB.btnBatalClick(Sender: TObject);
begin
  inherited;
  ClearAll;
  Self.Jenis := '';
...
procedure TFrmSalesOrderB.btnSimpanClick(Sender: TObject);
var
...
procedure TFrmSalesOrderB.nxGrdCellDblClick(Sender: TObject; ACol, ARow: Integer);
var
  q: TZQuery;
begin
...
procedure TFrmSalesOrderB.btnHapusClick(Sender: TObject);
var
  q: TZQuery;
  i: Integer;
begin
...
procedure TFrmSalesOrderB.btnTambahClick(Sender: TObject);
var
  s: TStringList;
  fKode: TField;
  ACol, ARow, i: Integer;
...
procedure TFrmSalesOrderB.cxdTglTrsPropertiesChange(Sender: TObject);
begin
  {
...
procedure TFrmSalesOrderB.btnEdit2Click(Sender: TObject);
var
  q, qBrg: TZQuery;
  i: Integer;
begin
...
procedure TFrmSalesOrderB.cxCmbKategoriSOPropertiesChange(Sender: TObject);
var
  sKat: string;
  i: Integer;
  tx: TcxCheckListBoxItem;
...
procedure TFrmSalesOrderB.ResetCheckEmail;
var
  lst: TStringList;
  tx: TcxCheckListBoxItem;
  i: Integer;
...
procedure TFrmSalesOrderB.SendEmailSO(sNoBukti: string; jenis: string);
var
  em: ThreadKirimEmail;
...
function TFrmSalesOrderB.GenerateHTML(sNoBukti: string) : string;
var
  lst: TStringList;
  sMemo: string;
  i: Integer;
...
procedure TFrmSalesOrderB.cxLUCustPropertiesChange(Sender: TObject);
begin
  try
    if Self.Jenis <> 'edit' then begin
...
procedure TFrmSalesOrderB.NxButtonEdit1ButtonClick(Sender: TObject);
var
  i: integer;
begin
  i := nxGrd.SelectedRow;
...
procedure TFrmSalesOrderB.cxLUBrgKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
...
procedure TFrmSalesOrderB.cxsQtyKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then begin
    btnTambahClick(nil);
    cxsQty.EditValue := 0;
...
procedure TFrmSalesOrderB.GetDaftarEmail;
var
  lst: TStringList;
  cmb : TcxComboBox;
  i,j: Integer;
...
procedure TFrmSalesOrderB.Button1Click(Sender: TObject);
begin
  inherited;
  MsgBox(IntToStr(cxCmbKategoriSO.ItemIndex));
end;

procedure TFrmSalesOrderB.btnCariCustClick(Sender: TObject);
var
  f: TfrmCari;
  s: TStringList;
  fKode: TField;
...
procedure TFrmSalesOrderB.pnlMemoExit(Sender: TObject);
begin
  pnlMemo.Visible := False;
end;

procedure TFrmSalesOrderB.NxTextColumn4ButtonClick(Sender: TObject);
begin
  cxMemo.Lines.Text := nxGrd.Cell[CKET,nxGrd.SelectedRow].AsString;
  pnlMemo.Visible := True;
  pnlMemo.SetFocus;
...
procedure TFrmSalesOrderB.btnSimpanKetClick(Sender: TObject);
begin
...
procedure TFrmSalesOrderB.btnBatalMemoClick(Sender: TObject);
begin
  inherited;
  pnlMemo.Visible := False;
end;

procedure TFrmSalesOrderB.cxMemoExit(Sender: TObject);
begin
  inherited;
  btnSimpanKetClick(nil);
end;

procedure TFrmSalesOrderB.idSMTPWorkBegin(ASender: TObject;
...
procedure TFrmSalesOrderB.idSMTPWorkEnd(ASender: TObject;
  AWorkMode: TWorkMode);
begin
  try
    dm.zConn.StartTransaction;
...
procedure TFrmSalesOrderB.btnCariBrgClick(Sender: TObject);
var
  f: TFrmCari;
  s: TStringList;
  fKode: TField;
...
procedure TFrmSalesOrderB.nxGrdCellClick(Sender: TObject; ACol,
  ARow: Integer);
var
  q: TZQuery;
begin
