...
var
  frmApprovalLKM: TfrmApprovalLKM;
...
procedure TfrmApprovalLKM.CreateParams(var Params: TCreateParams);
begin
  inherited CreateParams(Params);
  Params.ExStyle := Params.ExStyle or WS_EX_APPWINDOW;
end;

procedure TfrmApprovalLKM.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Release;
end;

procedure TfrmApprovalLKM.FormCreate(Sender: TObject);
var
  sSQL: string;
begin
...
procedure TfrmApprovalLKM.nxGrdCellClick(Sender: TObject; ACol,
  ARow: Integer);
begin
...
procedure TfrmApprovalLKM.btnApprovalClick(Sender: TObject);
var
  i: Integer;
  q, q2: TZQuery;
  tbl: TZTable;
...
procedure TfrmApprovalLKM.btnBatalClick(Sender: TObject);
begin
  Close;
end;

procedure TfrmApprovalLKM.nxGrdAfterEdit(Sender: TObject; ACol,
