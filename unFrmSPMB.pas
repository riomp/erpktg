...
procedure TFrmSPMB.CreateParams(var Params: TCreateParams);
begin
  inherited CreateParams(Params);
  Params.ExStyle := Params.ExStyle or WS_EX_APPWINDOW;
end;

procedure TFrmSPMB.FormCreate(Sender: TObject);
var
  q: TZQuery;
begin
  inherited;
...
function TFrmSPMB.CekKodeBrg(sKodeBrg : String; Row: Integer) : Boolean;
var
  i: integer;
  tmp: Boolean;
begin
...
procedure TFrmSPMB.NxEdit1DblClick(Sender: TObject);
var
  f: TFrmCari;
  fs: TfrmCariSO;
  s: TStringList;
...
procedure TFrmSPMB.nxGrdAfterEdit(Sender: TObject; ACol, ARow: Integer;
  Value: WideString);
var
  q, qb, qc: TZQuery;
  i: integer;
...
procedure TFrmSPMB.HitungTotal;
var
  i: integer;
  tmp, tmpQty: Real;
begin
...
procedure TFrmSPMB.btnBatalClick(Sender: TObject);
begin
  inherited;
  ClearAll;
  Self.Jenis := '';
...
procedure TFrmSPMB.btnEditClick(Sender: TObject);
begin
  inherited;
  btnCariPO.Visible := True;
end;

procedure TFrmSPMB.btnSimpanClick(Sender: TObject);
var
...
procedure TFrmSPMB.nxGrdCellDblClick(Sender: TObject; ACol, ARow: Integer);
var
  f: TFrmEditQtySO;
  q: TZQuery;
  i: integer;
...
procedure TFrmSPMB.btnHapusClick(Sender: TObject);
var
  q: TZQuery;
  i: Integer;
begin
...
procedure TFrmSPMB.cxCmbGdgPropertiesChange(Sender: TObject);
begin
  inherited;
  try
...
procedure TFrmSPMB.btnTambahClick(Sender: TObject);
var
  s: TStringList;
  fKode: TField;
  ACol, ARow: Integer;
...
procedure TFrmSPMB.cxCmbGdgEnter(Sender: TObject);
begin
  inherited;
  if cxsTotalQty.Value > 0 then
...
procedure TFrmSPMB.btnEdit2Click(Sender: TObject);
var
...
procedure TfrmSPMB.AddRow(sNoSO, sKodeBrg: string; qty_so, qty_g02: real);
var
  f: TFrmCari;
  fs: TfrmCariSO;
  s: TStringList;
...
procedure TfrmSPMB.FormShow(Sender: TObject);
var
  lst: TList;
begin
  Screen.Cursor := crSQLWait;
...
procedure TfrmSPMB.cxlNoSOPropertiesEditValueChanged(Sender: TObject);
var
  q, qsj: TZQuery;
  i: integer;
begin
...
procedure TfrmSPMB.btnCetakSJClick(Sender: TObject);
var
  sj_det, sj_head, brg, brg_det,
  hist, q, qso, qcek, qSO_V_SJ, qp, qc_dis: TZQuery;
  sNoSJ: string;
  qty_susut: Real;
  f: TFrmSJ;
  fLap : TFrmLapUmum;
    ...
    if q.IsEmpty then begin
      ...
      try
        ...
        for ii := 0 to nxGrd.RowCount - 1 do begin
          ...
          with brg do begin
            if Locate('kode', nxGrd.Cell[CKD_BRG,ii].AsInteger,[]) then begin
              Edit;
          ...
          with brg_det do begin
            if Locate('kode_brg;kode_gdg',
              VarArrayOf([nxGrd.Cell[CKD_BRG,ii].AsInteger,'G02']),[]) then begin
              Edit;
              FieldByName('stok').AsFloat :=
                FieldByName('stok').AsFloat - nxGrd.Cell[CQTY,ii].AsFloat;
              Post;
...
procedure TfrmSPMB.btnCetakSPMBClick(Sender: TObject);
var
  q: TZQuery;
  f: TfrmLapUmum;
begin
...
procedure TfrmSPMB.UpdateSOTerbuka(sNoSPMB: string);
var
  q, qSO_V_SJ: TZQuery;
  qso, qsj: TZQuery;
  sNoSO: string;
...
procedure TfrmSPMB.btnCariCustClick(Sender: TObject);
var
  f: TfrmCari;
  s: TStringList;
  fKode: TField;
...
procedure TfrmSPMB.btnHapusSPMBClick(Sender: TObject);
var
  q: TZQuery;
  i: Integer;
...
procedure TfrmSPMB.btnAmbilKetClick(Sender: TObject);
var
  i: Integer;
  q: TZQuery;
begin
...
procedure TfrmSPMB.cxChkTampilSPMBAllClick(Sender: TObject);
begin
  zqrNoBukti.Close;
...
procedure TfrmSPMB.btnSimpanKetClick(Sender: TObject);
begin
...
procedure TfrmSPMB.btnBatalMemoClick(Sender: TObject);
begin
  pnlMemo.Visible := False;
end;

procedure TfrmSPMB.cxMemoExit(Sender: TObject);
begin
  inherited;
  btnSimpanKetClick(nil);
end;

procedure TfrmSPMB.Button1Click(Sender: TObject);
var
  i: integer;
begin
  ListBox1.Clear;
...
procedure TfrmSPMB.cxMemo2Exit(Sender: TObject);
begin
...
procedure TfrmSPMB.btnShowMemoClick(Sender: TObject);
begin
...
procedure TfrmSPMB.AddRow(sNoSO, sKodeBrg: string; qty_so, qty_g02, qb, qa, qr: real);
var
  f: TFrmCari;
  fs: TfrmCariSO;
  s: TStringList;
...
procedure TfrmSPMB.HitungBeratTotal;
begin
  //
end;

procedure TfrmSPMB.nxBtnEditButtonClick(Sender: TObject);
var
  ACol,ARow: integer;
  fd: TFrmDetHslPel;
begin
...
procedure TfrmSPMB.CollectList(lst: TStringList; jenis: string);
var
  i,j: Integer;
begin
...
procedure TfrmSPMB.UpdateDetPel;
var
  i: Integer;
begin
...
procedure TfrmSPMB.UpdateTotQtyPel;
var
  ARow: integer;
begin
  ARow := nxGrd.SelectedRow;
...
procedure TfrmSPMB.cxdTglRencKirimPropertiesEditValueChanged(
  Sender: TObject);
begin
...
procedure TfrmSPMB.cxChkSopirLuarClick(Sender: TObject);
begin
  if cxChkSopirLuar.Checked then begin
    cxlArmada.Visible := False;
    cxlDriver.Visible := False;
...
procedure TfrmSPMB.CetakSuratJalan;
var
  sj_head, sj_det, qcek,
...
procedure TfrmSPMB.UpdateSOTerbukaPlt(sNoSPMB: string);
var
...
procedure TfrmSPMB.SendEmailSOCompleted(sNoSO: string);
var
  i : Integer;
  sTmp: string;
  lst: TStringList;
...
procedure TfrmSPMB.cxChkPPNClick(Sender: TObject);
begin
