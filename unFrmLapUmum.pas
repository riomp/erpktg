...
type
  TfrmLapUmum = class(TForm)
    ...
    lbl2: TLabel;
    zqrJadDatang: TZReadOnlyQuery;
    dsJadDatang: TDataSource;
    fDBJadDatang: TfrxDBDataset;
    rptJadDatang: TfrxReport;
    lbl3: TLabel;
    zqrJadPengiriman: TZReadOnlyQuery;
    dsJadPengiriman: TDataSource;
    fdbJadPengiriman: TfrxDBDataset;
    rptJadPengiriman: TfrxReport;
