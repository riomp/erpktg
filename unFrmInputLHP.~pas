...
uses
  ...
  dxSkinSharp, dxSkinSilver, dxSkinSpringTime, dxSkinStardust,DateUtils,
  dxSkinsDefaultPainters, dxSkinscxPCPainter, cxStyles, cxCustomData,
  cxFilter, cxData, cxDataStorage, cxSpinEdit, cxDBLookupComboBox,
  cxCalendar, cxTextEdit, cxDropDownEdit, cxCheckBox, DB,
  ZAbstractRODataset, ZDataset, cxLookupEdit, cxDBLookupEdit, cxGridLevel,
  cxGridCustomTableView, cxGridTableView, cxClasses, cxGridCustomView,
  cxGrid, cxPC, cxMaskEdit, StdCtrls, ExtCtrls,
...
uses unDm, unAplikasi, unTools, unFrmCari;
...
begin
  ...
  if Self.Jenis ='edit' then begin
    ...
    cxtLOT.Text           := b.FieldBYName('lot').AsString;
...
procedure TfrmInputLHP.cxlMesinPropertiesChange(Sender: TObject);
var
  tanggal : TDate ;
  tgl,bln : ShortInt ;
  thn : Integer;
